...
static constexpr auto qt_meta_stringdata_ZN14CPUSchedulerOSE = QtMocHelpers::stringData(
    "CPUSchedulerOS",
    "on_OK_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14CPUSchedulerOSE[] = {
...
Q_CONSTINIT const QMetaObject CPUSchedulerOS::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14CPUSchedulerOSE.offsetsAndSizes,
    qt_meta_data_ZN14CPUSchedulerOSE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14CPUSchedulerOSE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CPUSchedulerOS, std::true_type>,
...
void *CPUSchedulerOS::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14CPUSchedulerOSE.stringdata0))
